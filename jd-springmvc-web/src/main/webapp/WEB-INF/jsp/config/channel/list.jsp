...
<head>
	...
	<style>
		...
		.item{margin:3px;font-weight:normal}
	</style>
</head>
<body>
	...
	<div class="row">
		<div class="col-sm-2 fix">
			<div class="list-group">
				...
				<a class="list-group-item active" href="/manage/config/channel/list">渠道维护</a>
		...
		<div class="col-sm-10 col-sm-offset-2">
            <div class="container-fluid">
                <ol class="breadcrumb breadcrumb-sm">
                	...
                	<li class="active">渠道维护</li>
                </ol>
            </div>
            <div style="padding:0px 15px" class="container-fluid">
				<div style="background-color:#f7f7f7;padding:15px">
				<form class="form-inline" action="/manage/config/channel/list">
			        <button class="btn btn-default" type="submit"><span class="glyphicon glyphicon-search"></span> 查询</button>
					<div class="pull-right">
						<a class="btn btn-primary" href="/manage/config/channel/add"><span class="glyphicon glyphicon-plus"></span>新建渠道</a>
			        </div>
			    </form>
			    </div> 
			</div>
			...
			<div class="container-fluid">
				<table class="table table-bordered table-hover table-striped table-condensed">
					...
					<tbody >
						<c:forEach items="${list}" var="channel" varStatus="vs">
						<tr>
							<td>${channel.id}</td>
							<td>${channel.channelName}</td>
							<td>
								<a href="/manage/config/channel/delete/${channel.id}" onclick="return delcfm();">删除</a>
							</td>
						</tr>
						</c:forEach>
					</tbody>
...
function delcfm(){
	if (!confirm("删除渠道将使所有包含该渠道的系统均失效，确定删除？")) {
        return false;
    }
    return true;
}
