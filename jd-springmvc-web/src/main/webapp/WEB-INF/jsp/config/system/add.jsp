...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-sm-10 col-sm-offset-2">
			...
			<div class="container-fluid">
				<form class="form-horizontal" action="/manage/config/system/add" method="post">
					<div class="form-group">
						<label class="col-sm-1 control-label">系统名称</label>
						<div class="col-sm-5">
							<input type="text" class="form-control" placeholder="系统名称" name="systemName" id="systemName"/>
						</div>
					</div>
					<div class="form-group">
