...
(function () {
    ...
    b.prototype.xml = function (l, f) {
        var h = l.replace(/>\s{0,}</g, "><").replace(/</g, "~::~<").replace(/\s*xmlns\:/g, "~::~xmlns:").replace(/\s*xmlns\=/g, "~::~xmlns=").split("~::~"), i = h.length, m = false, k = 0, j = "", g = 0, e = f ? a(f) : this.shift;
        for (g = 0; g < i; g++) {
            if (h[g].search(/<!/) > -1) {
                j += e[k] + h[g];
                m = true;
    ...
    b.prototype.css = function (l, j) {
        var i = l.replace(/\s{1,}/g, " ").replace(/\{/g, "{~::~").replace(/\}/g, "~::~}~::~").replace(/\;/g, ";~::~").replace(/\/\*/g, "~::~/*").replace(/\*\//g, "*/~::~").replace(/~::~\s{0,}~::~/g, "~::~").split("~::~"), e = i.length, h = 0, k = "", g = 0, f = j ? a(j) : this.shift;
        for (g = 0; g < e; g++) {
            if (/\{/.exec(i[g])) {
                k += f[h++] + i[g]
            } else {
    ...
    b.prototype.sql = function (q, g) {
        var n = q.replace(/\s{1,}/g, " ").replace(/\'/ig, "~::~'").split("~::~"), l = n.length, j = [], p = 0, h = this.step, r = true, k = false, f = 0, m = "", i = 0, e = g ? a(g) : this.shift;
        for (i = 0; i < l; i++) {
            if (i % 2) {
                j = j.concat(n[i])
            } else {
...
(function () {
    ...
    function a() {
        ...
        this.regexList = [{
            ...
            regex: /!important/g,
            css: "color3"
        }, {regex: new RegExp(b(e), "gm"), css: "keyword"}, {
            regex: new RegExp(d(c), "g"),
            css: "value"
        }, {regex: new RegExp(this.getKeywords(f), "g"), css: "color1"}];
...
(function () {
    ...
    function a() {
        ...
        this.regexList = [{
            ...
            css: "color1"
        }, {regex: new RegExp(this.getKeywords(d), "gmi"), css: "keyword"}]
    }
