...
$(function () {
    ...
    jQuery("ul.fe-function-list li").click(function (d) {
        var b = $(this).attr("data-msgtype");
        var c = $(this).attr("data-usefile");
        if (b == "COLOR_PICKER") {
            a.BgPageInstance.showColorPicker()
        } else {
            a.BgPageInstance.runHelper({msgType: MSG_TYPE[b], useFile: c})
        }
        window.close()
    })
});