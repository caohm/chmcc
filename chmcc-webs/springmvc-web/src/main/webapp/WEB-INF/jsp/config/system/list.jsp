	...
	<div class="row">
		...
		<div class="col-sm-10 col-sm-offset-2">
            ...
            <div style="padding:0px 15px" class="container-fluid">
				...
				<form class="form-inline" action="/manage/config/system/list">
			        <button class="btn btn-default" type="submit"><span class="glyphicon glyphicon-search"></span> 查询</button>
					<div class="pull-right">
						<a class="btn btn-primary" href="/manage/config/system/add"><span class="glyphicon glyphicon-plus"></span>新建系统</a>
			        </div>
			    </form>
			    </div> 
			</div>
			...
			<div class="container-fluid">
				<table class="table table-bordered table-hover table-striped table-condensed">
					...
					<tbody >
						<c:forEach items="${list}" var="system" varStatus="vs">
						<tr>
							<td>${system.id}</td>
							<td>${system.systemName}</td>
							<td>
								<a href="/manage/config/system/delete/${system.id}" onclick="return delcfm();">删除</a>
								&nbsp;&nbsp;&nbsp;
								<a href="/manage/config/system/addChannel/${system.id}/false">配置渠道</a>
							</td>
						</tr>
						</c:forEach>
					</tbody>
