		...
		<div class="col-sm-10 col-sm-offset-2">
            <div class="container-fluid">
                <ol class="breadcrumb breadcrumb-sm">
                	...
                	<li><a href="/manage/config/channel/list">渠道维护</a></li>
                	<li class="active">新建渠道</li>
                </ol>
            </div>
			<div class="container-fluid">
				<form class="form-horizontal" action="/manage/config/channel/add" method="post">
					<div class="form-group">
						<label class="col-sm-1 control-label">渠道名称</label>
						<div class="col-sm-5">
							<input type="text" class="form-control" placeholder="渠道名称" name="channelName" id="channelName"/>
						</div>
					</div>
					<div class="form-group">
