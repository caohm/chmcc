...
<span><a href="orderinfo" target="_blank"><h3>订单中心流程监控</h3></a></span>

<iframe src="allDetail" id="iframepage" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" style="height:100%;width: 100%"></iframe>
</body>
</html>
<script>
function refresh()
